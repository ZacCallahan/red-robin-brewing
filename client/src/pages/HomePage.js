    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="mb-8">
        <div className="bg-gradient-to-r from-black to-gray-800 rounded-xl p-2 mb-8 text-center">
          <h3 className="text-3xl font-bold text-white mb-2 font-serif select-none">Featured Collection</h3>
          <p className="text-gray-300 select-none">Discover our community's most celebrated craft beers</p>
        </div>
